...
DEFAULT_WELLS_CONFIG = {
    'connections': [
        {'name': 'P1', 'i': 29, 'j': 29, 'k': 0, 'type': 'producer', 'control': 'ORAT', 'value': 500.0, 'minbhp': 1000.0, 'wellbore_radius': 0.09525, 'completion_ratio':0.5, 'shutin_days': [[1000.0, 0.0]]},
        {'name': 'P2', 'i': 29, 'j': 9, 'k': 0, 'type': 'producer', 'control': 'ORAT', 'value': 10000.0, 'minbhp': 1000.0,'wellbore_radius': 0.09525, 'completion_ratio':0.5, 'shutin_days': [[1000.0, 0.0]]},
        {'name': 'P3', 'i': 9, 'j': 9, 'k': 0, 'type': 'producer', 'control': 'ORAT', 'value': 1500.0, 'minbhp': 1000.0,'wellbore_radius': 0.09525, 'completion_ratio':0.5, 'shutin_days': [[1000.0, 0.0]]},
        {'name': 'P4', 'i': 9, 'j': 29, 'k': 0, 'type': 'producer', 'control': 'ORAT', 'value': 2000.0, 'minbhp': 1000.0,'wellbore_radius': 0.09525, 'completion_ratio':0.5, 'shutin_days': [[1000.0, 0.0]]},
        {'name': 'I1', 'i': 19, 'j': 19, 'k': 0, 'type': 'injector', 'control': 'ORAT', 'value': 0., 'minbhp': 1000.0,'wellbore_radius': 0.09525, 'completion_ratio':0.5, 'shutin_days': [[1000.0, 0.0]]}
    ],
}
...
DEFAULT_ENCODER_DECODER_CONFIG = {
    ...
    'residual_params': {
        ...
        'Dropout': {'Add': True, 'Rate': 0.2, 'Layer': [1, 0, 0, 0]},
        'Skip_Connections': {'Add': True, 'Layers': [1, 1, 1, 1]},
        'Decoder_Filter_Fac': 1.0,
        'Latent_Layer': {'Flatten': False, 'Depth': 1, 'Width': 512, 'Activation': 'relu'},
...
# 3D specific configuration for encoder-decoder
DEFAULT_ENCODER_DECODER_3D_CONFIG = {
    'depth': 4,
    'width': {'Bottom_Size': 32, 'Growth_Rate': 1.5},
    'spatial_dims': 3,  # Set to 3 for 3D spatial input
    'temporal': False,
    'residual_params': {
        'Kernel_Size': 3,
        'Kernel_Init': 'he_normal',
...
def get_configuration(config_type, input_shape=None, use_rbf=False, fluid_type=None, fitting_method=None):
    ...
    if config_type.lower() == 'encoder_decoder':
        ...
        if input_shape and len(input_shape) >= 4 and input_shape[-3] > 1:
